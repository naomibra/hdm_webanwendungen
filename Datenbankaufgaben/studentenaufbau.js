...
//let test= [{"id":"1","Name":"Svea","Matrikelnummer":"456789","Studiengang":"DC","Noten":[{"Modul":"Chinesisch","Note":"1"},{"Modul":"Mathe","Note":"4"}]},{"id":"2","Name":"Zoe","Matrikelnummer":"99876","Studiengang":"DC","Noten":[{"Modul":"Chinesisch","Note":"1"},{"Modul":"Mathe","Note":"4"},{"Modul":"Mathe","Note":"2"},{"Modul":"SWE","Note":"2.4"}]}];
...
function cardsAufbauen(studenten){
     ...
     for(let i=0;i<array.length;i++){
        ...
        let divcard =document.createElement("div");
         ...
         cc.appendChild(divcard);
       
        let bild=document.createElement("img");
        bild.setAttribute("src","/Users/NaomiBraening/Desktop/Hochschule der medien/Semester5/Bilder_web/default-user-image.png");
        ...
        //console.log(array[i].Noten[i].Modul);
